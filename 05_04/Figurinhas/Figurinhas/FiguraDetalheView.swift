    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            HStack {
                ...
                VStack(alignment: .leading) {
                    ProprieadesView(valorInt: figura.vidas, tipo: .numeroInteiro)
                    ProprieadesView(imagem: "bolt", nome: "Potência", valorDecimal: figura.potencia, cor: .yellow, tipo: .numeroDecimal)
